        ...
        >
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
              className="p-2.5 rounded-full text-text-secondary-light dark:text-text-secondary-dark hover:bg-black hover:bg-opacity-10 dark:hover:bg-white dark:hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-accent-light dark:focus:ring-accent-dark focus:ring-offset-1 dark:focus:ring-offset-card-bg-light dark:dark:focus:ring-offset-card-bg-dark"
          ...
          <div className="space-y-6 flex-grow">
            {/* API Key */}
            <div>
              <label className="block text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark mb-1.5">API Key</label>
              <input
              ...
              <motion.button
                ...
                className="mt-2 w-full px-4 py-3 bg-accent-light dark:bg-accent-dark text-text-primary-dark dark:text-text-primary-light rounded-xl font-semibold hover:bg-accent-hover-light dark:hover:bg-accent-hover-dark focus:outline-none focus:ring-2 focus:ring-accent-light dark:focus:ring-accent-dark focus:ring-offset-2 dark:focus:ring-offset-card-bg-light dark:dark:focus:ring-offset-card-bg-dark flex items-center justify-center disabled:opacity-60"
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    className="mt-3 text-base text-red-600 dark:text-red-400"
                  >
                    {error}
                  </motion.div>
                )}
            ...
            {/* Model Selection */}
            <div>
              <label className="block text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark mb-1.5">Model</label>
              <select
                value={model}
              ...
              <motion.button
                ...
                className="mt-2 w-full px-4 py-3 bg-accent-light dark:bg-accent-dark text-text-primary-dark dark:text-text-primary-light rounded-xl font-semibold hover:bg-accent-hover-light dark:hover:bg-accent-hover-dark focus:outline-none focus:ring-2 focus:ring-accent-light dark:focus:ring-accent-dark focus:ring-offset-2 dark:focus:ring-offset-card-bg-light dark:dark:focus:ring-offset-card-bg-dark disabled:opacity-60"
            ...
            {/* Add Custom Model */}
            <div>
              <label className="block text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark mb-1.5">Add Custom Model</label>
              <input
                type="text"
                value={newModel}
            ...
            {/* System Prompt */}
            <div>
              <label className="block text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark mb-1.5">System Prompt</label>
              <textarea
                value={systemPrompt}
            ...
            {/* Max Tokens */}
            <div>
              <label className="block text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark mb-1.5">Max Tokens</label>
              <input
                type="number"
                value={maxTokens}
          ...
          <div className="mt-auto pt-6"> {/* Pushes to bottom */}
            <motion.button
              ...
              className="w-full px-4 py-2.5 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white rounded-xl font-semibold focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-600 focus:ring-offset-2 dark:focus:ring-offset-card-bg-light dark:dark:focus:ring-offset-card-bg-dark"
